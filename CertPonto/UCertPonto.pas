...
uses
  ...
  Soap.Rio, Soap.SOAPHTTPClient, StrUtils;
...
begin
  ...
  strHora := SplitString(certTest.SincroniaPeriodicaDoRelogio(), ' ')[0];
  strData := SplitString(certTest.SincroniaPeriodicaDoRelogio(), ' ')[1];
  edtData.Text := strData;
  edtHora.Text := strHora;
end;
